 ...
 */
class ParadaList extends TStandardList
{
    ...
    public function __construct()
    {
        ...
        parent::setActiveRecord('Parada');   // defines the active record
        ...
        parent::addFilterField('ativo', 'like', 'ativo'); // filterField, operator, formField
        
        // creates the form
        $this->form = new TQuickForm('form_search_Parada');
        $this->form->class = 'tform'; // change CSS class
        
        $this->form->style = 'display: table;width:100%'; // change style
        $this->form->setFormTitle('Parada');
        ...
        $this->form->setData( TSession::getValue('Parada_filter_data') );
        
        // add the search form actions
        $this->form->addQuickAction(_t('Find'), new TAction(array($this, 'onSearch')), 'fa:search');
        $this->form->addQuickAction(_t('New'),  new TAction(array('ParadaForm', 'onEdit')), 'bs:plus-sign green');
        ...
        // create EDIT action
        $action_edit = new TDataGridAction(array('ParadaForm', 'onEdit'));
