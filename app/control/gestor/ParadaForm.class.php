 ...
 */
class ParadaForm extends TPage
{
    protected $form; // form
    ...
    public function __construct( $param )
    {
        ...
        // creates the form
        $this->form = new TQuickForm('form_Parada');
    ...
    public function onSave( $param )
    {
        try
        {
            ...
            **/
            ...
            $object = new Parada;  // create an empty object
    ...
    public function onEdit( $param )
    {
        try
        {
            if (isset($param['key']))
            {
                ...
                TTransaction::open('gestor'); // open a transaction
                $object = new Parada($key); // instantiates the Active Record
