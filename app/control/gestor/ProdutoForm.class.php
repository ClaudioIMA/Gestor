...
class ProdutoForm extends TPage
{
    ...
    public function __construct( $param )
    {
        ...
        // add the fields
        $this->form->addQuickField('Codigo', $codigo,  200, new TRequiredValidator );
        $this->form->addQuickField('Descrição', $descricao,  200 , new TRequiredValidator);
        $this->form->addQuickField('Prod Hora', $prod_hora,  100 , new TRequiredValidator);
        $this->form->addQuickField('Ciclo', $ciclo,  100 , new TRequiredValidator);
        $this->form->addQuickField('Ativo', $ativo,  200 , new TRequiredValidator);
        $codigo->setSize(200,30);
        $descricao->setSize(200,30);
        $prod_hora->setSize(200,30);
        $ciclo->setSize(200,30);
